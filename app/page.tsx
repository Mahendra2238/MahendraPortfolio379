      ...
      <Section id="projects" title="Projects">
        <div className="relative group">
          ...
          >
            ...
            <article
              key={p.title}
              className="group w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-0.66rem)] flex-none snap-center overflow-hidden rounded-xl border bg-card shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-xl hover:shadow-blue-500/20"
            >
